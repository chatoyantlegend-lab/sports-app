...
$query = "SELECT username, description FROM users WHERE id ='$user_id'";
  ...
  <div class="main-content">
    ...
    <div class="profile-card">
      ...
      <div class="profile-info">
        <h2 class="username" id="username-display"><?php echo htmlspecialchars($user['username']); ?></h2>
        <p class="description" id="description-display"><?php echo htmlspecialchars($user['description']); ?></p>
      </div>
    ...
    <div class="profile-overview">
        <div class="overview-item">Current Steps: <span id="current-steps">0</span></div><br></br>
        <div class="overview-item">Next Workout: <span id="next-workout">No upcoming workout</span></div><br></br>
